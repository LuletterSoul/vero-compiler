...
@Getter
@Setter
public class LexerTransitionInfo
{
    ...
    public LexerTransitionInfo(Integer[][] realCompressedTransitionTable, Integer[] charClassTable,
    ...
    public Integer getStateIndex(Integer tokenIndex)
    {
        ...
        for (Integer i = 0; i < acceptTableLength; i++ )
        {
            ...
            {
                if (acceptTables[i][j].equals(tokenIndex))
                {
                    possibleIndex = j;
                }
            }
